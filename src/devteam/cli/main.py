...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--provider', type=str, default=settings.provider, choices=['anthropic', 'azure-openai', 'free', 'groq', 'ollama', 'openai'], help='LLM provider to use (default: ollama)')
